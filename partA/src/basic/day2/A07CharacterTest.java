...
public class A07CharacterTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("'가' 문자의 유니코드 값 : "+(int)c3);
		...
		//int와 char 형식 변수 사이의 캐스팅 (char-> int 자동)
		int code3 = c3;			//****c3은 '가' 를 int 로 자동 캐스팅하면 44032
		char temp = (char)code3;
		...
		System.out.println("변경된 code3 : " + code3);		//44032
		System.out.println("변경된 code3 문자 : " + (char)code3);		//***int를 char로 강제 캐스팅. '각', 출력 형식을 바꾸기 위한 캐스팅
