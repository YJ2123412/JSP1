        ...
        while (run) {       //메뉴 선택 반복
            ...
            switch (select) {
                ...
                case "B","b": //구매하기
                    ...
                    //buyDao.buy1(bv);
                    //맵사용
                    if(buyDao.buy2(bv) ==1) System.out.println("상품을 담았습니다.");
                    else //참조 테이블에 없는 값 입력했을때
                        System.out.println("테이블에 없는 값을 입력한 오류입니다.");
                    break;
                ...
                case "D","d": //구매 취소
                    ...
                    //맵사용
                    if(buyDao.delete(deleteidx) ==1) System.out.println("정상적으로 취소 되었습니다.");
                    else //참조 테이블에 없는 값 입력했을때
                ...
                case "Q","q": //구매 수량 변경
                    ...
                    //buyDao.modify(bv, changeidx, changNumber);
                    ...
                    if(buyDao.modify(arg) ==1) {System.out.println("정상적으로 수정 되었습니다.");}
                    else //참조 테이블에 없는 값 입력했을때
                        System.out.println("없는 구매 번호입니다.");
                    break;  
