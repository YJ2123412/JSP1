...
/*  클래스의 상속 - 자바에서 제공하는 클래스들의 상속관계를 이해하기 위함. 우리가 직접 만드는 것은 몇가지 기능정도.
		...
		ㄴ 구체화할 때 Shape 클래스를 상속받는다. 부모클래스 Shape은 모든 도형들의 공통적인 필드와 메소드를 정의.
...
public class Shape {    
		...
		//도형의 너비가 MAX_WIDTH를 넣으면 도화지가 작아서 못그림...등 기준을 정하는 예시
		//상수는 상속의 의미가 없습니다
		...
		// ㄴ 변경 : shapeNameaks 만 setter가 필요해서 추가합니다.
    ...
    public void setShapeName(String shapeName){
     this.shapeName = shapeName;
		...
		//자식 클래스들이 draw를 재정의해서 다른 메세지가 출력되게 만들 예정입니다.
		public void draw(){
