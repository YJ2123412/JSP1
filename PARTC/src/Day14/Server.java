...
public class Server {
    public static void main(String[] args) {
        ...
        try {
           ...
           bos = new BufferedOutputStream(new FileOutputStream("C:\\Users\\YJ\\Desktop\\Coding\\Main\\"+filename));
            ...
            //자원해제. close()
            try {server.close(); socket.close(); bos.close(); is.close(); dis.close(); os.close(); dos.close();} catch (IOException e) {}
        }
    }
}
